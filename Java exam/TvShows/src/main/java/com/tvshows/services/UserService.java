...
import com.tvshows.models.LoginUser;
import com.tvshows.models.User;
import com.tvshows.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
        ...
        Optional<User> maybeUserNameTaken= userRepo.findByUserName(newUser.getUserName());
        if(maybeUserNameTaken.isPresent()) {
        	result.rejectValue("userName", "registraterError", "This User Name is already taken!");
        }
